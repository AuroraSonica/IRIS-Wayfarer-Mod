"""v0.9.5 pak: the proven v0.8 pak byte-verbatim + the POLISH W3 motlist
...
MOTLIST_SRC = RS / "exports" / "w3_housecat_full_AXISFIX.motlist.751"
FLUFFY = RS / "w3_housecat_fluffy_v0.9.5"
PAK = FLUFFY / "IRIS_10_housecat_v095.pak"
ZIP = RS / "IRIS_HouseCat_Prototype_v0.9.5_FluffyMod.zip"
...
version=0.9.5-axisfix-pak
description=W3 house cat: proven v0.8 body + the FIELD-PROVEN axis-fixed Witcher-3 motion catalogue (no polish-round edits; bank 904, 17 clips). Supersedes every earlier version.
author=Aurora and Lyra and Iris
""", encoding="utf-8")
(FLUFFY / "README.txt").write_text("""IRIS House Cat Prototype v0.9.5 (polish pak)
============================================
